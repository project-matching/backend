...
class EmailServiceImplTest {
    ...
    class CheckConfirmEmail {
        ...
        void success() {
            ...
            given(emailAuthRepository.findByEmailAndAuthTokenAndPurpose(email, authToken, purpose)).
