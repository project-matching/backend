...
class ParticipateRequestTechnicalStackRepositoryTest {
    ...
    class testDeleteByProjectNo {
        ...
        public void testSuccess() throws Exception {
            ...
            participateRequestTechnicalStackRepository.save(participateRequestTechnicalStack3);

            // when
            assertEquals(participateRequestTechnicalStackRepository.findAll().size(), 3);

            participateRequestTechnicalStackRepository.deleteByProjectNo(saveProject1.getNo());
